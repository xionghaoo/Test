...
//                        Log.d(TAG, "adding work profile to non filtered list: " + app._label + ", " + app._packageName + ", " + app._className);
...
//            if (Tool.isPackageInstalled(appSettings.getIconPack(), _packageManager)) {
//                IconPackHelper.applyIconPack(AppManager.this, Tool.dp2px(52), appSettings.getIconPack(), appsTemp);
//            }
            return null;
        }
