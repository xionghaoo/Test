...
public final class ItemOptionView extends FrameLayout {
    ...
    public final class OverlayView extends View {
        ...
        public OverlayView() {
            super(com.benny.openlauncher.widget.ItemOptionView.this.getContext());
            setWillNotDraw(false);
        }

        public boolean onTouchEvent(@Nullable MotionEvent event) {
            if (event == null || event.getActionMasked() != 0 || com.benny.openlauncher.widget.ItemOptionView.this.getDragging() || !com.benny.openlauncher.widget.ItemOptionView.this._overlayPopupShowing) {
                return super.onTouchEvent(event);
            }
            com.benny.openlauncher.widget.ItemOptionView.this.collapse();
            // 消耗事件
            return true;
        }
    ...
    public ItemOptionView(@NonNull Context context, @Nullable AttributeSet attrs) {
        ...
        addView(_overlayView, new LayoutParams(-1, -1));  // MATCH_PARENT
        addView(_overlayPopup, new LayoutParams(-2, -2));  // WRAP_CONTENT
        setWillNotDraw(false);
    }
